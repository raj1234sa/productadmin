{# {{ include(twc.FILE_FILENAME_WITHOUT_EXT~'.tpl') }} #}
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
		...
		<title>{{ twc.CONFIG_SITE_NAME }}</title>
		<meta content="" name="description">
		<meta content="" name="keywords">

		<!-- Favicons -->
		<link href="{{ twc.SITE_FAVICON }}" rel="icon">
		<link
		href="{{ twc.SITE_FAVICON }}" rel="apple-touch-icon">
			...
			<div class="container-fluid">
				<div class="row justify-content-center">
					<div class="col-xl-10 d-flex align-items-center">
						<a href="{{ twc.SITE_URL }}" title="{{ twc.CONFIG_SITE_NAME }}" class="logo mr-auto"><img src="{{ twc.SITE_LOGO }}"></a>
			...
			<div class="container d-md-flex py-4">
				...
				<div class="mr-md-auto text-center text-md-left">
					<div class="copyright">
						&copy; Copyright
						<strong>
							<span>{{ twc.CONFIG_SITE_NAME }}</span>
